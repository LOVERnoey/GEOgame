...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2025 at 09:36 AM
...
(1, 'How to open game!!!!!!!!!!!!!', '67b34bfe1a384.jpg', 6, '67b34bfe1a48d.png', 'Do you wanna know how i got into these Game? A lot of Gamer don’t even know how to get into game So i’m Here to tell the \r\ntell from god that whisper in my ear Just Click “PLAY” Button\r\nThat’s it now you can enjoy you beloved game', 1, 1);
...
INSERT INTO `users` (`id`, `user_id`, `user_name`, `password`, `date`, `image`, `county`, `user_email`, `bio`, `x`, `facebook`, `instagram`, `youtube`, `background_image`, `role`) VALUES
(1, 3392, 'bass2', '123456', '2025-02-23 14:37:37', '67b1fba5e28f5.gif', '', '', 'GEOgame เป็นเว็บไซต์ที่สร้างขึ้นเพื่อให้ผู้ใช้ได้สนุกกับเกมที่เกี่ยวข้องกับภูมิศาสตร์ พร้อมทั้งเป็นแพลตฟอร์มที่เปิดโอกาสให้ผู้ใช้สามารถจัดการโปรไฟล์ของตนเองได้อย่างอิสระ ไม่ว่าจะเป็นการแก้ไขข้อมูลส่วนตัว อัปโหลดรูปโปรไฟล์ และเพิ่มข้อมูลโซเชียลมีเดียต่างๆ\r\n\r\nเว็บนี้ถูกออกแบบมาให้ใช้งานง่าย มีอินเทอร์เฟซที่สะอาดตาและเป็นมิตรต่อผู้ใช้ รองรับทั้งเดสก์ท็อปและมือถือ เป้าหมายหลักของเราคือการสร้างชุมชนสำหรับคนที่รักการเล่นเกมเชิงการศึกษา รวมถึงให้ผู้ใช้สามารถเชื่อมต่อกับกันและกันผ่านแพลตฟอร์มโซเชียลต่างๆ\r\n\r\nGEOgame ไม่เพียงแต่เป็นแค่เกม แต่ยังเป็นพื้นที่สำหรับการเรียนรู้และพัฒนาทักษะด้านภูมิศาสตร์ไปพร้อมกับความสนุกอีกด้วย', 'L', 'Ratchakit Sriprapai', 'ratcha_skir', 'LOVERnoey', '67b201bcd7061.gif', 'admin'),
(3, 40348405639316575, 'กกกก', '123456', '2025-03-03 07:29:08', '67adf32a51e62.jpg', 'Thailand', '', '', 'กฟห', 'กหฟ', 'กหฟ', 'กหฟ', '67b476eb7cf5f.jpg', NULL);
...
--
ALTER TABLE `gamecommu`
  MODIFY `game_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `guide`
--
ALTER TABLE `guide`
  MODIFY `guide_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
